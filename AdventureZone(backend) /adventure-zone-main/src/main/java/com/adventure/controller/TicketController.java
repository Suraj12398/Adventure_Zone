...
public class TicketController {
	...
	@PostMapping("/tickets/{cusId}/{catNames}")
	public ResponseEntity<Ticket> addTicket(@Valid @RequestBody Ticket ticket, @PathVariable Integer cusId, @PathVariable List<String> catNames ){
